...
public class GitlabTranslationService implements TranslationService {
    ...
    public GitlabTranslationService(ReqourConfig reqourConfig, TranslationServiceCommons translationServiceCommons) {
        this.gitLabProviderConfig = reqourConfig.gitConfigs().gitProvidersConfig().gitlabProviderConfig();
