...
class GithubTranslationServiceTest {
    ...
    @Test
    void externalToInternal_repositoryWithGroup_returnsRepositoryWithGroupPrefixed() {
    ...
    @Test
    void externalToInternal_repositoryWithoutGroup_returnsRepositoryInInternalGroup() {
    ...
    @Test
    void externalToInternal_repositoryInInternalGroup_returnsRepositoryInInternalGroup() {
