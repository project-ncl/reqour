...
public class AdjustmentPusher {
    ...
    /**
     * Push the adjustment changes
     */
    public AdjustmentPushResult pushAdjustmentChanges(Path workdir, String alignmentRootVersion, String tagMessage) {
        ...
        if (tagName == null) {
            ...
            tagName = createTag(workdir, alignmentRootVersion, tagMessage);
        }
        log.debug("Tag name is '{}'", tagName);
