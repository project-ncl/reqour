 ...
 * Any new clone provider should be registered within the config as supported provider - its name from there has to
 * match the value returned by {@link this#name()}.
 */
