...
/**
 * Utility class which creates {@link List<String>}. These correspond to git commands. Every such element of the list is
 * one argument of the command. <br/>
 * It differs from {@link GitCommands} that this class contains only creations of git commands, no aggregated commands
 * above them.
 */
public class GitUtils {
    ...
    public static List<String> isReferenceBranch(String ref, String remote) {
        return List.of("git", "show-ref", "-q", "--heads", remote, ref);
    }

    public static List<String> isReferenceTag(String ref, String remote) {
        return List.of("git", "show-ref", "-q", "--tags", remote, ref);
    }
