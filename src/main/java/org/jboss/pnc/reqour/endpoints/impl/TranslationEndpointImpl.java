...
public class TranslationEndpointImpl implements TranslationEndpoint {
    ...
    @Override
    public ExternalToInternalDTO externalToInternal(ExternalToInternalDTO externalToInternalDto) {
        // Just a dummy implementation for now
        return ExternalToInternalDTO.builder()
                .externalUrl(externalToInternalDto.getExternalUrl())
